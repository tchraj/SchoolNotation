        ...
        <div class="container px-6 mx-auto grid py-6 " style="background-color: #0ea5e9">
            <form action="{{ route('univs.store') }}" method="POST" class="mt-6">
                ...
                <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    ...
                    <form id="contact_form" method="POST">
                        ...
                        <div id="contacts-container">
                            <div class="contact">
                                ...
                                <input type="text" name="contacts[]" class="text-sm" placeholder="Numéro de téléphone">
                    ...
                    <button type="button" onclick="addMail()">Ajouter Mail</button>
                    ...
                    <button type="button" onclick="addFormation()">Ajouter Formation</button>

                    <div id="sites-container">
                        <label for="sites">Sites</label>
                        <div class="site">
                            <input type="text" name="websites[]" placeholder="iai-togo@iai-togo.tg">
                            <button type="button" onclick="removeWebsite(this)">Supprimer</button>
                        </div>
                    </div>
                    <button type="button" onclick="addWebsite()">Ajouter Site</button>
